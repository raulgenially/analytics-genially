...
-- Here we create a mart model where all the transformations common to both models are applied.
-- This macro is intended to be used in the mart models for both collections.
