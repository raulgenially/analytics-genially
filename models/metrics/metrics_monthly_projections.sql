...
final as (
    select
        *,
        ...
        -- lag n_new_creators
        {{ get_lag_dimension_metrics_reporting('n_new_creators', week_days, 'date_day') }} as n_new_creators_previous_7d,
        {{ get_lag_dimension_metrics_reporting('n_new_creators', month_days, 'date_day') }} as n_new_creators_previous_28d,
        {{ get_lag_dimension_metrics_reporting('n_new_creators', year_days, 'date_day') }} as n_new_creators_previous_364d,
        -- lag n_new_creators_registered_same_day
        {{ get_lag_dimension_metrics_reporting('n_new_creators_registered_same_day', week_days, 'date_day') }} as n_new_creators_registered_same_day_previous_7d,
        {{ get_lag_dimension_metrics_reporting('n_new_creators_registered_same_day', month_days, 'date_day') }} as n_new_creators_registered_same_day_previous_28d,
        {{ get_lag_dimension_metrics_reporting('n_new_creators_registered_same_day', year_days, 'date_day') }} as n_new_creators_registered_same_day_previous_364d,
        -- lag n_new_creators_previously_registered
        {{ get_lag_dimension_metrics_reporting('n_new_creators_previously_registered', week_days, 'date_day') }} as n_new_creators_previously_registered_previous_7d,
        {{ get_lag_dimension_metrics_reporting('n_new_creators_previously_registered', month_days, 'date_day') }} as n_new_creators_previously_registered_previous_28d,
        {{ get_lag_dimension_metrics_reporting('n_new_creators_previously_registered', year_days, 'date_day') }} as n_new_creators_previously_registered_previous_364d,
        --lag n_total_visitors
        {{ get_lag_dimension_metrics_reporting('n_total_visitors', week_days, 'date_day') }} as n_total_visitors_previous_7d,
        {{ get_lag_dimension_metrics_reporting('n_total_visitors', month_days, 'date_day') }} as n_total_visitors_previous_28d,
        {{ get_lag_dimension_metrics_reporting('n_total_visitors', year_days, 'date_day') }} as n_total_visitors_previous_364d,
